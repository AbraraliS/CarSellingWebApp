        ...
        <div class="navbar1">
            ...
            <ul>
               ...
               <li><a href="BuyHist.jsp">Buy History</a></li>
                ...
                <li class="active1"><a href="ChangePass.jsp">Change Password</a></li>
                <!--<li><a href="#privacy-policy">Privacy Policy</a></li>-->
            </ul>
        </div>
        <div class="container1">
            <h1>Change Password</h1><br>
            <h4>User Name:<%= name%></h4><br>
            <form action="update" method="POST">
                <!-- <label for="user_id">User ID:</label>
            <input type="text" id="user_id" name="user_id"> -->
                <label for="U_name">Enter Old Password:</label>
                <input type="text" id="U_name" name="userid" placeholder="Old Password">


                <label for="U_name">Enter New Password:</label>
                <input type="text" id="U_name" name="uname" placeholder="New Password">



                <label for="Password">Re-Enter New Password:</label>
                <input type="password" id="Password" name="passwd" placeholder="********">
