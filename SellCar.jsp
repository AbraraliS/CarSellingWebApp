            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-nav-first">
                        ...
                        <li  class="active"><a href="SellCar.jsp">Sell Cars</a></li>
        ...
        <div class="sellcartop">
            <div class="selectop">
                ...
                <div class="custom-select">
                    ...
                    <input type="text" name="kmdrive" placeholder="Enter Car name" required>
                    </select>
                </div>

                <div class="custom-select">
                    <label for="RegYear">Regestration Year : </label><br>
                    <select class="form-select" aria-label="Select Regestration Year :">
                ...
                <div class="custom-select">
                    ...
                    <input type="number" name="kmdrive" placeholder="How many KM driven" maxlength="8" required>
                </div>
                ...
                <div class="custom-select">
                    <form method="post">
                        ...
                        <select class="form-select" aria-label="Select a Car Brand" name="brand" onchange="this.form.submit()">

                            <option selected disabled hidden>Select a Car Brand</option>
                            <% // Display user data
                                while (rs.next()) {
                            ...
                            <!--                            <option selected disabled hidden>Select a Car Brand</option>
                                                        ...
                                                        <option value="2">Tech Innovators</option>
                ...
                <div class="custom-select">
                    <form method="post">
                        <%
                            ...
                            try {
                                // SQL query to fetch user data
                                String query = "SELECT * FROM carmodels WHERE BrandID='" + bid + "'";
                                PreparedStatement stmt = conn.prepareStatement(query);
                                ResultSet rs = stmt.executeQuery();
                        %>
                        <label for="carModel">Car Model :</label><br>
                        <select class="form-select" aria-label="Select a Car Model" name="model" onchange="this.form.submit()">
                            <option selected disabled hidden>Select a Car Model</option>
                            <% // Display user data
                                while (rs.next()) {
                ...
                <div class="custom-select">
                    ...
                    <%
                        ...
                        try {
                            // SQL query to fetch user data
                            String query = "SELECT * FROM carvariants WHERE ModelID='" + mid + "'";
                            PreparedStatement stmt = conn.prepareStatement(query);
                            ResultSet rs = stmt.executeQuery();
                    %>
                    <label for="carVarient">Car Variant:</label><br>
                    <select class="form-select" aria-label="Select a Car Variant">
                        <option selected disabled hidden>Select a Car Variant</option>
                        <% // Display user data
                            while (rs.next()) {
                                int variantid = rs.getInt("VariantID");
                                String varienttype = rs.getString("VariantType");
                                String fueltype = rs.getString("FuelType");
                        %>
                        <option value="<%=variantid%>"><%=varienttype%> FuelType:<%=fueltype%></option>
                        <%
                                }
                            } catch (Exception e) {
                                e.printStackTrace();
                ...
                <div class="custom-select">
                    ...
                    <textarea id="carDescription" name="car_description" rows="4" cols="40" required></textarea>

                </div>
                <div class="custom-select">
                    <label for="carPhoto">Address:</label><br>
                    <input type="text" name="addrs">
                </div>
                <div class="custom-select">
                    <label for="carPhoto">Photo:</label>
            ...
            <div class="buttn1"><button type="submit" class="btn" id="Submite">SUBMIT</button></div>
        </div>
        <!--</form>-->
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="footer-info">
                            ...
                            <address>
                                <p>+91 7203957428</p>
                                <p><a href="mailto:contact@company.com">cardeal@gmail.com</a></p>
                            </address>
